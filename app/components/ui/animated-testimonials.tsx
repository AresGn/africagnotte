...
export const AnimatedTestimonials = ({
  ...
  // Résoudre le problème d'hydratation en attendant que le client soit prêt
  useEffect(() => {
    setIsClient(true);
  }, []);
  ...
  // Ne pas rendre les animations côté serveur pour éviter les erreurs d'hydratation
  if (!isClient) {
    return (
